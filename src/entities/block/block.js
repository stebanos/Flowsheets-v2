 ...
 * @returns {Block}
 */
export function createBlock({ id, name, x, y, width, height, code = '', isStringConcat = false, visualizationType = 'default', vizOptions = {} }) {
    return { id, name, x, y, width, height, code, isStringConcat, visualizationType, vizOptions };
}
